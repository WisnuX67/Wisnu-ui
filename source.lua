...
local Custom = {} do
	...
	Custom.DefaultIcon = "rbxassetid://130008176530837"
...
local function OpenClose()
	...
	local Close_ImageButton = Custom:Create("ImageButton", {
		...
		Image = "rbxassetid://130008176530837",
		Visible = false,
	}, ScreenGui)
...
function MugiHub_Library:CreateWindow(Config)
	...
	Custom:Create("UIStroke", {Color = Color3.fromRGB(255, 255, 255), Thickness = 1.2, Transparency = 0.7}, Main)
